...
<div class="row">
<div class="col">
<h1>usuarios <a href="/lib/usuarios/actions/insertar.php" class="btn btn-primary">añadir</a></h1>
</div>
    ...
    <tr>
        ...
        <td>
          ...
          <a href="editar.php?id=<?php echo $row['id'] ?> "  class="btn btn-warning" >editar</a>
            ...
            <a href="usuarios/eliminar.php?id=<?php echo $row['id'] ?> " class="btn btn-danger">eliminar</a>
        </td>
    </tr>
    <?php } ?>
</tbody>
